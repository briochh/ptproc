...
ipt.heatgen(mod,geo,dat,grid,heat_flux,function={'type':'log','points':[[5.0,2.],[10000.,0.24]]},inject=[150,1e-3,1.67e6])
ptg.gen_constant(mod,geo,grid,dat,constant=3e-5,enthalpy='var')#enthalpy=8440.)
