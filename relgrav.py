...
save='yes'
ref_mod='20140613_2_py_it'
mod='20140613_2_py_it'
t0=time.clock()


os.chdir('C:/Users/glbjch/Local Documents/Work/Modelling/Pytough/'+ref_mod+'/results/mark2')
ref_grav=vstack(np.loadtxt('axsym_int_microgal5.dat')).T
#ref_grav=np.array([[1.,5.,12.],[5.,8.,10.]])

os.chdir('C:/Users/glbjch/Local Documents/Work/Modelling/Pytough/'+mod+'/results/mark2')
grav=vstack(np.loadtxt('axsym_int_microgal5.dat')).T
...
if save is 'yes':                 
   savetxt('gravdiff5.dat',zip(times,gravdif))
   im1.savefig('vsref5.pdf')   
   im1.savefig('vsref5.png')
   f = open('relresultxt5.txt','w')
   f.write('Model = '+mod+'\n'
               'Base = 20140613_2_py_itP5 \n'
